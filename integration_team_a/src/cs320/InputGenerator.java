...
class InputGenerator {
	...
	public static String randomDateString() {
		...
		int hours = randomDateHour();
		int minutes = randomDateMinute();
		int seconds = randomDateSecond();
		int milliseconds = randomDateMillisecond();
		return String.format("%02d/%02d/%d %02d:%02d:%02d.%03d", 
	...
	public static PatientRecord randomPatientRecord() {
		...
		record.SetSummaryMode(summaryMode);
	...
	public static PatientInfo randomPatient() {
        ...
        temp.SetMedicalNumber((long)randomInt());
